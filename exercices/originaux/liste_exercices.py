...
# Ecrire un script qui affiche, par famille, chacune des personnes avec un "-" en début de ligne.
liste_brut = [["Bruno", "Sylvie", "Remy"], [
    "Plume", "Rose", "Roger"], ["Christian", "Maud", "Albert"]]

for famille in liste_brut:
